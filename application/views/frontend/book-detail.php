                ...
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div class="text-center mb-3">
                        <div class="d-grid gap-2">
                            <a target="_blank" href="<?php print site_url(); ?>print/<?php print $data[0]['sISBN']; ?>" class="btn btn-primary btn-block"><i class="fas fa-print"></i> Print Production Sheet</a>
                            <a target="_blank" href="<?php print site_url()."cover/".$data[0]['sUUID']; ?>" class="btn btn-primary btn-block "><i class="fas fa-download"></i> Download Original Cover</a>
                            <a target="_blank" href="<?php print site_url()."coverx/".$data[0]['sUUID']; ?>" class="btn btn-primary btn-block "><i class="fas fa-download"></i> Download Thumbnail Cover</a>
                        </div>
                    </div>                    
                    <!--<div class="mb-4">
